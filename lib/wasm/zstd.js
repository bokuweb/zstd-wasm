...
Module['_ZSTD_compressBound'] = function () {
  return (_ZSTD_compressBound = Module['_ZSTD_compressBound'] = Module['asm']['i']).apply(null, arguments);
};
...
Module['_ZSTD_getFrameContentSize'] = function () {
  return (_ZSTD_getFrameContentSize = Module['_ZSTD_getFrameContentSize'] = Module['asm']['k']).apply(null, arguments);
};
Module['_ZSTD_decompress'] = function () {
  return (_ZSTD_decompress = Module['_ZSTD_decompress'] = Module['asm']['l']).apply(null, arguments);
};
